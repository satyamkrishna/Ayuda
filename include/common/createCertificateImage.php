...
class createImage
{
	...
	public function createCertificateImage($name,$regno,$filename,$font_name="../../resources/fonts/timesi.ttf",$font_size_name=14,$font_reg="../../resources/fonts/timesi.ttf",$font_size_reg=16)
	{
		...
		Imagettftext($im, $font_size_name, 0, $start_x_name, $start_y_name, $black, $font_name, $name);
